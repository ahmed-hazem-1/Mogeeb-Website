...
import { Brain, RefreshCw, Cloud, Zap, Lightbulb, Globe, Star, Users } from 'lucide-react'
  ...
  const technologies = [
    {
      ...
      description: 'Advanced Large Language Models for intelligent conversations',
      icon: Brain,
      color: 'bg-brand-teal'
    },
    {
      name: 'n8n Workflows',
      description: 'Seamless automation and integration capabilities',
      icon: RefreshCw,
    ...
    },
    {
      ...
      description: 'Lightning-fast response times for optimal user experience',
      icon: Zap,
      color: 'bg-yellow-500'
    }
  ]
  ...
  const values = [
    {
      title: 'Innovation',
      titleAr: 'الابتكار',
      description: 'Pushing the boundaries of Arabic AI technology',
      icon: Lightbulb,
      color: 'bg-purple-500'
    },
    {
      ...
      description: 'Making AI technology accessible to all businesses',
      icon: Globe,
      color: 'bg-green-500'
    },
    {
    ...
    },
    {
      ...
      description: 'Deep appreciation for Arabic language and culture',
      icon: Users,
      color: 'bg-brand-teal'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We are a startup focused on creating smart chatbots for different purposes, 
            helping SMEs and enterprises reduce costs and save time through intelligent automation 
            and social media integration solutions.
          </p>
        </motion.div>
